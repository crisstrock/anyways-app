...
@EnableWebMvc
@Configuration
@ComponentScan(basePackages = { "com.mexcrisoft.anyways.controller", "com.mexcrisoft.anyways.repositories",
	"com.mexcrisoft.anyways.service" })
@PropertySource("classpath:application.properties")
public class AnywaysAppConfig implements WebMvcConfigurer {
	private Logger logger = LoggerFactory.getLogger(AnywaysAppConfig.class);
	@Autowired
	private Environment env;

	/**
	 * Interceptor de contenido web
	...
	public WebContentInterceptor webContentInterceptor() {
		logger.debug("===> Método webContentInterceptor()");
	...
	public InternalResourceViewResolver viewResolver() {
		logger.debug("===> Método viewResolver()");
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		logger.debug("===> Método addResourceHandlers()");
	...
	public void addFormatters(FormatterRegistry registry) {
		logger.debug("===> Método addFormatters()");
	...
	public DataSource dataSource() {
		logger.debug("===> Método dataSource()");
